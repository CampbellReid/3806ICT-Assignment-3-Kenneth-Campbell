...
"""autogenerated by genpy from assignment3/Goal.msg. Do not edit."""
import codecs
import sys
...
class Goal(genpy.Message):
  _md5sum = "1536c8d5a376720204f5d100ab20ac1d"
  _type = "assignment3/Goal"
...
float64 z
"""
  __slots__ = ['description','priority','waypoints']
  _slot_types = ['string','int32','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       description,priority,waypoints
