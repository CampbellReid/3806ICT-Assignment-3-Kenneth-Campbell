...
(cl:defmethod cl:initialize-instance :after ((m <Obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment3-msg:<Obstacle> is deprecated: use assignment3-msg:Obstacle instead.")))
...
(cl:defmethod size-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment3-msg:size-val is deprecated.  Use assignment3-msg:size instead.")
  (size m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Obstacle>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%float32 size~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Obstacle)))
  "Returns full string definition for message of type 'Obstacle"
  (cl:format cl:nil "geometry_msgs/Point position~%float32 size~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
